            ...
            <Box sx={{ display: tab !== 0 ? "none" : "div" }}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        >
                            ...
                            <Typography sx={{ fontSize: "1.125rem", px: 3, py: 3 }}>
                                The following visualizes the modeling of possible changes in the policy design of a
                                specific farm payment program, Agriculture Risk Coverage, County Option (ARC-CO). It
                                provides an initial demonstration or example for how revising program calculations can
                                impact payments to farmers
                            </Typography>
                        </Grid>
                    </Grid>
                </Box>
                    ...
                    <Grid container spacing={2}>
                        ...
                        >
                            <Grid item md={6}>
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 3 }}>
                                    It provides income supporting payments to farmers who enroll eligible acres.
                                    Payments are triggered when a crop’s revenue (Prices x Yields) falls below a
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 0.5 }}>
                                    Benchmark = 5-year Olympic (drop highest and lowest year) average of national
                                    average prices and county average yields.
                                </Typography>
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 0.5 }}>
                                    Guarantee = <b>86%</b> of Benchmark.{" "}
                                </Typography>
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 0.5 }}>
                                    Payment Rate = Difference between actual revenue in the year (national average
                                    prices X county average yields) and the Guarantee; not to exceed <b>10%</b> of
                                    benchmark
                                </Typography>
                            </Grid>
                            <Grid item md={6} sx={{ borderLeft: "1px solid #0000001F" }}>
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, pb: 3, pt: 0.5 }}>
                                    ...
                                    actual revenue calculation in the crop year is discounted or reduced by <b>$50</b>{" "}
                                    per acre to account for cost of cover crop adoption.
                                </Typography>
                                <Typography sx={{ fontWeight: 600, fontSize: "1.25rem", px: 3, py: 0.5 }}>
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 0.5 }}>
                                    Payment Rate = Difference between actual revenue in the year (national average
                                    prices X county average yields) and the Guarantee; not to exceed <b>15%</b> of
                                    benchmark <TrendIcon bkColor="#2F7164" fontColor="white" text="Increased" />
                                </Typography>
                            </Grid>
                        </Grid>
                    </Grid>
                ...
                <Box>
                    ...
                    <Grid container spacing={2} sx={{ backgroundColor: "white", borderRadius: 1, mt: 4.5 }}>
                        ...
                        >
                            <Typography
                                sx={{ fontWeight: 700, fontSize: "1.125rem", px: 3, py: 0.5, color: "#2F7164" }}
                            >
                                Related Paper:
                            </Typography>
                        ...
                        >
                            <Grid item md={6}>
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 3 }}>
                                    ...
                                    sinking into the rich loam. Shafts of light danced upon the forest floor,
                                    illuminating delicate ferns and wildflowers that clung to life in the shadowed
                                    realm. The trees stood sentinel, their gnarled roots intertwining like old lovers,
                                    secrets whispered through the ages. And as I followed the winding path deeper into
                                    the heart of the forest, I wondered what mysteries awaited me—the ancient guardians,
                                    the forgotten ruins, or perhaps something more elusive, hidden just beyond sight
                                </Typography>
                            </Grid>
                            <Grid item md={6} sx={{ borderLeft: "1px solid #0000001F" }}>
                                ...
                                <Typography sx={{ fontSize: "1.125rem", px: 3, py: 0.5 }}>
                                    In the heart of the ancient forest, where sunlight filtered through a canopy of
                                    emerald leaves, a hidden path beckoned to those who dared to venture. The air was
                                    thick with the scent of moss and damp earth, and the distant calls of unseen birds
                                    echoed like forgotten memories.
                                </Typography>
                            </Grid>
                        </Grid>
                    </Grid>
