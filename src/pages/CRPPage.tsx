...
import chartData from "../data/CRP/CRP_STATUTE_PERFORMANCE_DATA.json";
    ...
    return (
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{ width: "100%" }}>
                ...
                <Drawer setCRPChecked={setChecked} />
                <Box sx={{ pl: 50, pr: 20 }}>
                    ...
                    <Box display="flex" justifyContent="center" flexDirection="column" sx={{ mt: 10, mb: 2 }}>
                        <Box display="flex" justifyContent="center">
                            <Typography variant="h5">
                                <strong>CRP: State Performance by Category of Practices</strong>
                            </Typography>
                        </Box>
                        <Typography sx={{ mt: 2 }}>CRP Placeholder</Typography>
                    </Box>
