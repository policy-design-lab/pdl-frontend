        ...
        >
            <Box sx={style}>
                ...
                <Typography id="modal-modal-description" sx={{ my: 2 }}>
                    ...
                    <a target="_blank" href="https://www.congress.gov/bill/117th-congress/house-bill/5376/text">117-169</a>). Among
                    other things, the Inflation Reduction Act (IRA) included an $18 billion investment of additional
                    funds appropriated to four Farm Bill Conservation programs: Environmental Quality Incentives Program
                    (
                    <a target="_blank" href="https://farmdocdaily.illinois.edu/2023/04/a-view-of-the-farm-bill-through-policy-design-part-1-eqip.html">
                        EQIP
                    </a>
                    ); Conservation Stewardship Program (
                    <a target="_blank" href="https://farmdocdaily.illinois.edu/2023/05/a-view-of-the-farm-bill-through-policy-design-part-2-csp.html">
                        CSP
                    </a>
                    ); Agricultural Conservation Easement Program (
                    <a target="_blank" href="https://farmdocdaily.illinois.edu/2023/10/a-view-of-the-farm-bill-through-policy-design-part-7-acep-and-rcpp.html">
                        ACEP
                    </a>
                    ...
                    <a target="_blank" href="https://www.congress.gov/bill/117th-congress/house-bill/5376/text">117-169</a>).
                </Typography>
                <Typography id="modal-modal-description" sx={{ my: 2 }}>
                    ...
                    Services (NRCS:{" "}
                    <a target="_blank" href="https://www.nrcs.usda.gov/resources/data-and-reports/rca-data-viewer">RCA Data Viewer</a>).
                    The information visualized below applies the allocation of funds by NRCS for Fiscal Year (FY) 2023,
                    the first year of the IRA appropriations, to the total Budget Authority to project the allocations
                    by State and conservation practices. Users can select multiple practices to provide comparisons and
                ...
                <Typography id="modal-modal-description" sx={{ my: 2 }}>
                    ...
                    <a target="_blank" href="https://www.cbo.gov/data/baseline-projections-selected-programs">
                    ...
                    <a target="_blank" href="https://www.cbo.gov/system/files/2024-06/51317-2024-06-usda.pdf">
