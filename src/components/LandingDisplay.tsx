...
import { Button, Card, CardActions, CardContent, CardMedia, Dialog, Grid, Typography } from "@mui/material";
        ...
        <Box sx={{ mx: "auto", width: "90%", mt: 0 }}>
            <Dialog open={alertOpen} onClose={handleAlertClose}>
                <Card sx={{ minWidth: 300, display: "flex", flexDirection: "column" }}>
                    <CardContent>
                        <Typography align="center" gutterBottom variant="h5" component="div" sx={{ color: "#242424" }}>
                    ...
                    <CardActions disableSpacing sx={{ mt: "auto", justifyContent: "center" }}>
                        <Button component={Link} to="/" size="small" onClick={handleAlertClose}>
