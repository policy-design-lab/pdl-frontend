          ...
          {({ geographies }) => (
            <>
              {geographies.map((geo) => {
                ...
                const statuteRecord =
                  statePerformance[geo.properties.name][0].statutes;
                const ACur = statuteRecord.find(
                  (s) => s.statuteName === "(6)(A) Practices"
                );
                const AArray = ACur.practiceCategories;
                const BCur = statuteRecord.find(
                    ...
                    <Box>
                      ...
                      >
                        <Typography sx={{ color: "#3F3F3F" }}>
                          $
                          {Number(categoryPayment / 1000000.0).toLocaleString(
                            undefined,
                            {
