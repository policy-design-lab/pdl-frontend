...
function Title1ProgramTable({
    ...
    if (subprogram.length > 0) {
      ...
      hashmap[state] = {
        ...
        paymentInPercentageNationwide:
          subProgramData[0].paymentInPercentageNationwide,
        paymentInPercentageWithinState:
          subProgramData[0].paymentInPercentageWithinState,
      };
    } else {
      hashmap[state] = {
  ...
  subprogram.length > 0? sortByDollars(resultData, "paymentInDollars"):sortByDollars(resultData, "programPaymentInDollars");
