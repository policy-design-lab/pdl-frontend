...
### Added
- Added the Soybean dashboard components and page to the main site [449](https://github.com/policy-design-lab/pdl-frontend/issues/449)
...
### Changed
- Switched the Payment Rate mode to the default mode with the Total Payment Rate mode in Henrique's map [#396](https://github.com/policy-design-lab/pdl-frontend/issues/396)

## [1.9.0] - 2025-06-27

### Added
- Add a new page and components to visualize Henrique's model [#370](https://github.com/policy-design-lab/pdl-frontend/issues/370)
...
### Changed
- Unhide the issue brief for release [#366](https://github.com/policy-design-lab/pdl-frontend/issues/366)
...
[1.19.0]: https://github.com/policy-design-lab/pdl-frontend/compare/1.18.0...1.19.0
[1.18.0]: https://github.com/policy-design-lab/pdl-frontend/compare/1.17.1...1.18.0
